    ...
    if ($select_query->execute()) {
        ...
        echo "<div class='property-details'>";
            echo "<div class='property-images'>";
                echo "<div class='exterior_image'>" . displayExterior($conn, $property_id) . "</div>";
                echo "<div class='interior_image'>" . displayInterior($conn, $property_id) . "</div>";
            echo "</div>";
            echo "<hr>";
            echo "<div class='header_info'>";
                echo "<div class='price'>$" . number_format($price, 0, '', ',') . "</div>";
                echo "<div class='beds'>" . $beds . " Beds" . "</div>";
                echo "<div class='separator'>|</div>";
                echo "<div class='baths'>" . $baths . " Baths" . "</div>";
                echo "<div class='separator'>|</div>";
                echo "<div class='sqft'>" . number_format($sqft, 0, '', ',') . " sqft" . "</div>";
            echo "</div>";
            echo "<div class='line2_info'>";
                echo "<div class='address'>" . $address . "</div>";
                echo "<div class='date_listed'>" . "Listed on: " . $date_listed . "</div>";
            echo "</div>";
            echo "<div class='line3_info'>";
                echo "<div class='residence_type'>" . "Resident Type: " . $residence_type . "</div>";
                echo "<div class='year_built'>" . "Built in ". $year_built . "</div>";
                $sqft_price = round($price/$sqft);
                echo "<div class='sqft_price'>" . "$". $sqft_price . " price/sqft" . "</div>";
            echo "</div>";
            echo "<div class='description'>" . "Description: <br>" . $description ."</div>";
        echo "</div>";
    } else {
        echo "Error executing query: " . $conn->error;
    }
